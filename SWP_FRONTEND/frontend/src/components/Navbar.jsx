    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className="nav-links">
          ...
          <Link to="/documents" className={`nav-link${location.pathname.startsWith('/documents') ? ' active' : ''}`}>Tài liệu</Link>
          ...
          {user ? (
            <>
              <button
                ...
                className={`nav-link management-btn${location.pathname.includes('dashboard') ? ' active' : ''}`}
              >
                Quản lý
              </button>
              
              {/* Only show notification bell for parent users */}
              {isParent() && (
                  ...
                  {showNotifications && (
                    <div className="notifications-dropdown">
                      <div className="notifications-header">
                        <h4>Thông báo</h4>
                        <span className="notifications-count">{notificationCount > 0 ? `${notificationCount} mới` : 'Không có thông báo mới'}</span>
                      </div>
              ...
              <div className="user-dropdown" ref={userDropdownRef}>
                ...
                {showUserDropdown && (
                  <div className="dropdown-menu">
                    ...
                    <Link to="/parent-dashboard?tab=profile" className="dropdown-item" onClick={() => setShowUserDropdown(false)}>
