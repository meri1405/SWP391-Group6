          ...
          {activeTab === "campaigns" ? (
            <>
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Vui lòng nhập tên đợt kiểm tra" },
                ]}
              >
              ...
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Vui lòng chọn các mục kiểm tra" },
                ]}
              >
                <Select
                  mode="multiple"
            ...
            <>
              ...
              <Form.Item
                ...
                label="Đợt kiểm tra"
                rules={[
                  { required: true, message: "Vui lòng chọn đợt kiểm tra" },
                ]}
              >
              ...
              <Form.Item
                ...
                label="Ngày kiểm tra"
                rules={[
                  { required: true, message: "Vui lòng chọn ngày kiểm tra" },
                ]}
              >
                <DatePicker style={{ width: "100%" }} format="DD/MM/YYYY" />
              </Form.Item>
              ...
              <Form.Item name="adviceNotes" label="Lời khuyên">
