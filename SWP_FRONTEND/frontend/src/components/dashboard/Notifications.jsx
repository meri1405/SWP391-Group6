...
const Notifications = () => {
  ...
  const getNotificationType = (notification) => {
    ...
    if (titleLower.includes('thuốc') || messageLower.includes('thuốc') ||
        titleLower.includes('medication') || messageLower.includes('medication') ||
        titleLower.includes('dùng thuốc') || messageLower.includes('dùng thuốc')) {
      return 'medication';
    }
  ...
  const determineActionRequired = (notification) => {
    ...
    return notification.medicationRequest || 
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      ...
      case 'medical-event': return 'fas fa-ambulance';
    ...
    <div className="notifications">      
                ...
                {notification.medicationRequest && (
                  <div className="notification-details">
                    <div className="detail-item">
                      <strong>Học sinh:</strong> {notification.medicationRequest.studentName || 'Không xác định'}
                    </div>
                    <div className="detail-item">
                      <strong>Trạng thái:</strong> 
                      <span className={`status-badge ${notification.medicationRequest.status?.toLowerCase()}`}>
                        {notification.medicationRequest.status || 'Không xác định'}
                      </span>
                    </div>
                  </div>
                )}
                  ...
                  <div className="notification-details">
                    <div className="detail-item">
                      <strong>Lịch uống thuốc:</strong> {notification.medicationSchedule.medicationName || 'Không xác định'}
                    </div>
                    <div className="detail-item">
                      <strong>Thời gian:</strong> {notification.medicationSchedule.scheduleTime || 'Không xác định'}
                    </div>
                  </div>
                )}
                  {/* Show formatted date */}
      ...
      {showVaccinationModal && (
        <VaccinationFormModal
          ...
          vaccinationFormId={selectedVaccinationFormId}          onClose={() => setShowVaccinationModal(false)}
