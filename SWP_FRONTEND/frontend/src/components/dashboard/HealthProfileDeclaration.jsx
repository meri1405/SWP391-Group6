          ...
          <Card title={`${selectedProfile ? 'Chỉnh sửa' : 'Tạo'} hồ sơ sức khỏe của ${
            ...
            ><Tabs 
              ...
              <Divider />
                ...
                {selectedProfile && (selectedProfile.status === 'APPROVED' || selectedProfile.status === 'REJECTED') && (
                  <div style={{ marginTop: '8px', color: '#1890ff', fontSize: '14px' }}>
                    Khi cập nhật hồ sơ đã duyệt/từ chối, trạng thái sẽ chuyển về "Đang chờ duyệt"
                  </div>
                )}
              </div>
            </Form>
