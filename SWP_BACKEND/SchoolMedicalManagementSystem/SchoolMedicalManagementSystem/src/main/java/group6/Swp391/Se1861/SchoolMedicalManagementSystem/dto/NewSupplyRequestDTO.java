...
/**
 * DTO for requesting new medical supplies that don't exist in the system
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NewSupplyRequestDTO {
    ...
    // Expiration date is optional for some items
